        ...
        <section className="showcase">
          <div className="overlay">
            <article className="text-white">
              <div className="ui search" class=" heading-center">
                <div className="ui icon input">
                <input class="text-center text-white text-xl mb-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 max-w-xl mx-auto mt-10 lg:gap-20 px-5"type="text" placeholder="Search" className="prompt" ></input>
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 max-w-xl mx-auto mt-10 lg:gap-20 px-5">
                <article>
